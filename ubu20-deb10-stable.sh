...
# // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "DEVELOPER : ${green}WIBU - SEKAI® ${NC}${YELLOW}(${NC} ${green} PREMIUM ${NC}${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
# // REPO    
REPO="https://raw.githubusercontent.com/WBVPN/Autoscript/GM/"
...
echo -e "\e[32mloading...\e[0m" 
clear
izinsc="https://raw.githubusercontent.com/WBVPN/Autoscript/GM/Register"
...
TIMES="10"
CHATID="5851934765"
KEY="6436577366:AAHzHBpC1qBA-9hT6vh4z5aUmDKr8U_dT2I"
...
<code>═══════════════════════</code>
<b>🇮🇩🇮🇩WIBU VPN PREMIUM🇮🇩🇮🇩</b>
<code>═══════════════════════</code>
<i>Automatic Notifications From Github</i>
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://wa.me/+6287757315408"}]]}' 
...
wget -q https://raw.githubusercontent.com/WBVPN/Autoscript/GM/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
